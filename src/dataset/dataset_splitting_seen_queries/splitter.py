...
if __name__=="__main__":
    ...
    for language in languages:
        ...
        train_base_path = f"/srv/upadro/dataset/{language}/unseen_queries/train"
        train_test_val_base_path = f"/srv/upadro/dataset/{language}/unseen_queries/train_test_val"
        val_base_path = f"/srv/upadro/dataset/{language}/unseen_queries/val"
        test_base_path = f"/srv/upadro/dataset/{language}/unseen_queries/test"
        unique_query_test_base_path = f"/srv/upadro/dataset/{language}/unseen_queries/unique_query_test"
        for file in files:
            ...
            while(rerun_split):
                ...
                if 0.08<(len(unseen_queries_test_data)/len(json_data))<0.15 or len(json_data) < 30:
                    rerun_split = False
